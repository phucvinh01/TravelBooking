...
const Tour = () => {
    ...
    const sumRating = _.sumBy(tourData.reviews && tourData.reviews, 'rating')
    const avg = _.round(sumRating / (tourData.reviews && tourData.reviews.length))
                                ...
                                <div className='tour-detail rounded-3 p-4 mb-3'>
                                    ...
                                    <div
                                        ...
                                        <Space
                                            ...
                                            <small className='fs-6 text-muted'>{avg ? avg : 0}</small>
                                        </Space>
